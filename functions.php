...
// style.css読み込み
wp_enqueue_style( 'my-style', get_stylesheet_directory_uri() . '/style.css', array(), '1.0.2');
...
function twpp_enqueue_scripts() {
  ...
  if (is_home() || is_category()) {
    ...
    wp_enqueue_script(
      'zoom-script',
      get_template_directory_uri() . '/js/jquery.zoomslider.min.js',
      array( 'jquery', 'modernizr-script' ),
      false,
      true
    );
    wp_enqueue_script(
      'zoomSlideSetting-script',
      get_template_directory_uri() . '/js/zoomSlideSetting.js',
      array( 'jquery', 'modernizr-script', 'zoom-script'),
      '1.0.0',
      true
    );
  }
  ...
  if (is_single()) {
    ...
    wp_enqueue_script(
      ...
      array( 'jquery', 'ofi-script', 'common-script', 'swiper-script' ),
      '1.0.0',
      true
    );
  }
